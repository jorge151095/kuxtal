...
const services_data = [
  {
    ...
    title:'Fotografía de Producto y figuras públicas.',
    text_1:'Crea un verdadero impacto en tus clientes, con fotografía de producto y figuras públicas, nuestros profesionales se encargarán de cubrir todo tipo de necesidades.',
    home:true,
    service_p_2:true,
  },
  {
    ...
    text_1:'Diseño, creación y deploy de páginas web de acuerdo a las necesidades de su negocio, desde una página donde puedan conocerte tus clientes, hasta un comercio electrónico o un sistema a la medida.',
    home:true,
    service_p_2:true,
  },
  {
    ...
    title:'Publicidad empresarial',
    text_1:'La publicidad Empresarial se basará en las necesidades que el cliente requiera para su negocio, los paquetes serán totalmente personalizados, para lograr los objetivos de la marca o empresa, (Ventas y posicionamiento).',
    home:true,
    service_p_2:true,
  },
  {
  ...
  // home four
  {
    ...
    duration:'.3s',
    delay:'.5s',
    img:'/assets/img/service/ads.svg',
    title:'Publicidad empresarial',
    border_effect:'',
    text_1:'At Collax we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast',
    home_4:true,
  ...
  },
  {
    ...
    duration:'.9s',
    delay:'1.1s',
    img:'/assets/img/service/style.svg',
  ...
  },
  {
    ...
    duration:'1s',
    delay:'1.1s',
    img:'/assets/img/service/commercial.svg',
    title:"Comerciales",
  ...
  },
  {
    ...
    duration:'1.1s',
    delay:'1.2s',
    img:'/assets/img/service/events.svg',
  ...
  {
    id:19,
    img:'/assets/img/service/photo.svg',
    top_border:true,
